...
import { 
  ...
  MdStar, MdCheckCircle, MdImage, MdInfo, MdLink, MdMap, MdPark, MdVerified
} from "react-icons/md";
        ...
        <div className="p-6 space-y-6">
          ...
          {activeTab === "images" && (
            <div>
              ...
              />
              <p className="text-xs text-gray-400 mt-3">Upload high-quality images. First image will be the cover.</p>
            </div>
          )}
